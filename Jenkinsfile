            ...
            steps{
                dir('kubernetes/') {
                             sh '''
                                 ...
                                 aws ecr get-login-password --region ap-south-1 | helm registry login | --username AWS | --password-stdin 487936429785.dkr.ecr.region.amazonaws.com
                                 helm push myapp-${helmversion}.tgz oci://487936429785.dkr.ecr.ap-south-1.amazonaws.com/
                            '''
                }
            }
        }
